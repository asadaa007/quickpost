...
if (process.env.RESEND_API_KEY?.trim()) {
  console.log("[QuickPost] RESEND_API_KEY is set — password reset emails will be sent via Resend.");
} else {
  console.warn(
    "[QuickPost] RESEND_API_KEY is not set — forgot-password will log reset links to the server console only."
  );
}
